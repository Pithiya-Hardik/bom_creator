...
# app_include_js = "/assets/custom_app/js/bom_creater.js"
app_include_js = "/assets/custom_app/js/bom_tree_view.js"
...
override_doctype_class = {
	"BOM Creator": "custom_app.public.py.bom_creator_override.BOMCreator"
}
